...
GEMBA IT е технологичното звено на GEMBA Team EOOD във Варна, България. Ние въртим [GembaPay](https://gembapay.com) (некустодиална платежна платформа, партньор на Stripe и PayPal), NFT тикетинг и останалия стек, който този блог обикновено дисектира. Gemba Industrial носи частта, която повечето софтуерни компании имитират: хора, които реално са стояли на permit гишето в 6 сутринта с екип зад гърба, който гори пари.
